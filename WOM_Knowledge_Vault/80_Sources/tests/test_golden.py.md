...
[GitHub原本・固定SHA](https://github.com/Yasushi-Osugi/wom_development_composite_node/blob/7d6c7d734ebdcb7b213bab3116ca59d3d4935f55/tests/test_golden.py) · [原文テキスト](../../90_Raw/tests/test_golden.py.txt)
...
| 種別 | 名前 | 行 | 説明の先頭行 |
|---|---|---:|---|
| FunctionDef | `test_golden_matches` | 38 | 記録した golden と現行エンジンの ppc/psi が一致する事。 |
