...
tags: [wom, code]
---
# wom/cockpit/__init__.py

静的コード資料（実行検証ではない）。

[GitHub原本・固定SHA](https://github.com/Yasushi-Osugi/wom_development_composite_node/blob/7d6c7d734ebdcb7b213bab3116ca59d3d4935f55/wom/cockpit/__init__.py) · [原文テキスト](../../../90_Raw/wom/cockpit/__init__.py.txt)
