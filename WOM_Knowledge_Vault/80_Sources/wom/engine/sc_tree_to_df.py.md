...
[GitHub原本・固定SHA](https://github.com/Yasushi-Osugi/wom_development_composite_node/blob/7d6c7d734ebdcb7b213bab3116ca59d3d4935f55/wom/engine/sc_tree_to_df.py) · [原文テキスト](../../../90_Raw/wom/engine/sc_tree_to_df.py.txt)
...
| 種別 | 名前 | 行 | 説明の先頭行 |
|---|---|---:|---|
| FunctionDef | `sc_tree_to_planning_df` | 40 | Convert SCTree lot-PSI data to a quantity DataFrame. |
| FunctionDef | `apply_inv_value` | 191 | Fill the inv_value column using unit_cost from sku_master. |
