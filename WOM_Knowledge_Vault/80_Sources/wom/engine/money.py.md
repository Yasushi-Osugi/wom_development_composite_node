...
[GitHub原本・固定SHA](https://github.com/Yasushi-Osugi/wom_development_composite_node/blob/7d6c7d734ebdcb7b213bab3116ca59d3d4935f55/wom/engine/money.py) · [原文テキスト](../../../90_Raw/wom/engine/money.py.txt)
...
| 種別 | 名前 | 行 | 説明の先頭行 |
|---|---|---:|---|
| FunctionDef | `evaluate_money` | 35 | Parameters |
| FunctionDef | `build_scenario_money_kpi` | 140 | Aggregate money summary to scenario level (total across all SKUs/Regions). |
