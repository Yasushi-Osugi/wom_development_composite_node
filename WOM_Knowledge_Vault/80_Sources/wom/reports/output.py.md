...
[GitHub原本・固定SHA](https://github.com/Yasushi-Osugi/wom_development_composite_node/blob/7d6c7d734ebdcb7b213bab3116ca59d3d4935f55/wom/reports/output.py) · [原文テキスト](../../../90_Raw/wom/reports/output.py.txt)
...
| 種別 | 名前 | 行 | 説明の先頭行 |
|---|---|---:|---|
| FunctionDef | `print_kpi_summary` | 20 | Print a KPI summary table to stdout. |
| FunctionDef | `print_at_risk` | 32 | Print at-risk SKUs to stdout. |
| FunctionDef | `write_csv` | 48 | Write one CSV per scenario plus summary files. |
| FunctionDef | `write_excel` | 91 | Write a multi-sheet Excel workbook with all results. |
