...
[GitHub原本・固定SHA](https://github.com/Yasushi-Osugi/wom_development_composite_node/blob/7d6c7d734ebdcb7b213bab3116ca59d3d4935f55/wom/ppc/ppc_psi_bridge.py) · [原文テキスト](../../../90_Raw/wom/ppc/ppc_psi_bridge.py.txt)
...
| 種別 | 名前 | 行 | 説明の先頭行 |
|---|---|---:|---|
| FunctionDef | `_region_to_channel` | 61 | Map a region string to a PPC channel_node name. |
| FunctionDef | `psi_to_sales_records` | 85 | Extract leaf_out supply quantities from sc_tree and build sales_records. |
| FunctionDef | `summarize_psi_records` | 178 | Return a one-line summary string for logging. |
