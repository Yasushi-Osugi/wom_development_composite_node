...
[GitHub原本・固定SHA](https://github.com/Yasushi-Osugi/wom_development_composite_node/blob/7d6c7d734ebdcb7b213bab3116ca59d3d4935f55/wom/ppc/ppc_tariff.py) · [原文テキスト](../../../90_Raw/wom/ppc/ppc_tariff.py.txt)
...
| 種別 | 名前 | 行 | 説明の先頭行 |
|---|---|---:|---|
| FunctionDef | `_resolve_node` | 46 | docstringなし（下のコード参照） |
| FunctionDef | `_resolve_chain` | 52 | Resolve dad_nodes_chain to ordered list; fall back to single dad_node. |
| FunctionDef | `run_tariff_and_landed_cost` | 92 | Step 3: Tariff, logistics, DAD node costs for the full DAD chain. |
