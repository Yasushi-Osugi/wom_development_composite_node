...
[GitHub原本・固定SHA](https://github.com/Yasushi-Osugi/wom_development_composite_node/blob/7d6c7d734ebdcb7b213bab3116ca59d3d4935f55/wom/ppc/ppc_kpi.py) · [原文テキスト](../../../90_Raw/wom/ppc/ppc_kpi.py.txt)
...
| 種別 | 名前 | 行 | 説明の先頭行 |
|---|---|---:|---|
| FunctionDef | `build_node_week_summary` | 39 | Aggregate PPCEvents by (node_id, week). |
| FunctionDef | `build_profit_zone_summary` | 85 | Aggregate by profit_zone_role. |
| FunctionDef | `build_node_pl_summary` | 129 | Full-horizon (all weeks combined) per-node P&L table -- "拠点別P/L評価". |
| FunctionDef | `build_kpi_summary` | 184 | Top-level KPI dict. |
