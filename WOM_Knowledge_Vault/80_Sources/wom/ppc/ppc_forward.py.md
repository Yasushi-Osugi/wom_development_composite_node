...
[GitHub原本・固定SHA](https://github.com/Yasushi-Osugi/wom_development_composite_node/blob/7d6c7d734ebdcb7b213bab3116ca59d3d4935f55/wom/ppc/ppc_forward.py) · [原文テキスト](../../../90_Raw/wom/ppc/ppc_forward.py.txt)
...
| 種別 | 名前 | 行 | 説明の先頭行 |
|---|---|---:|---|
| FunctionDef | `_resolve_node` | 29 | Resolve node name: accepts str or dict[product_id -> node_id]. |
| FunctionDef | `_resolve_node_list` | 36 | Resolve supplier_node to an ordered list of node_ids for a product. |
| FunctionDef | `run_forward_propagation` | 60 | Step 1: Forward cost accumulation from Supplier(s) -> MOM. |
