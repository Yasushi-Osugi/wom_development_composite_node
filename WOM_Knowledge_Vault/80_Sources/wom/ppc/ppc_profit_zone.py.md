...
[GitHub原本・固定SHA](https://github.com/Yasushi-Osugi/wom_development_composite_node/blob/7d6c7d734ebdcb7b213bab3116ca59d3d4935f55/wom/ppc/ppc_profit_zone.py) · [原文テキスト](../../../90_Raw/wom/ppc/ppc_profit_zone.py.txt)
...
| 種別 | 名前 | 行 | 説明の先頭行 |
|---|---|---:|---|
| FunctionDef | `_resolve_node` | 28 | docstringなし（下のコード参照） |
| FunctionDef | `run_profit_zone_allocation` | 34 | Step 4: Market revenue + channel costs. |
