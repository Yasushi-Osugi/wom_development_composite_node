...
[GitHub原本・固定SHA](https://github.com/Yasushi-Osugi/wom_development_composite_node/blob/7d6c7d734ebdcb7b213bab3116ca59d3d4935f55/wom/ppc/ppc_runner.py) · [原文テキスト](../../../90_Raw/wom/ppc/ppc_runner.py.txt)
...
| 種別 | 名前 | 行 | 説明の先頭行 |
|---|---|---:|---|
| FunctionDef | `run_ppc_from_psi` | 26 | Run the full PPC Simulation pipeline using PSI leaf-out quantities. |
