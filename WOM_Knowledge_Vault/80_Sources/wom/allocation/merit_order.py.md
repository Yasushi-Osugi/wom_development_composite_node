...
[GitHub原本・固定SHA](https://github.com/Yasushi-Osugi/wom_development_composite_node/blob/7d6c7d734ebdcb7b213bab3116ca59d3d4935f55/wom/allocation/merit_order.py) · [原文テキスト](../../../90_Raw/wom/allocation/merit_order.py.txt)
...
| 種別 | 名前 | 行 | 説明の先頭行 |
|---|---|---:|---|
| FunctionDef | `build_allocation_merit_order` | 30 | 市場を単位マージン降順に積んだメリットオーダーを組む。 |
| FunctionDef | `true_continuous_optimum` | 174 | cliff（数量依存関税）の on/off を全列挙し、各ケースを線形問題として |
| FunctionDef | `compare_with_grid` | 342 | メリットオーダー連続解と格子最適の乖離を定量化し、 |
