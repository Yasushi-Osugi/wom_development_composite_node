...
[GitHub原本・固定SHA](https://github.com/Yasushi-Osugi/wom_development_composite_node/blob/7d6c7d734ebdcb7b213bab3116ca59d3d4935f55/wom/plugins/buffering_stock_optimizer.py) · [原文テキスト](../../../90_Raw/wom/plugins/buffering_stock_optimizer.py.txt)
...
| 種別 | 名前 | 行 | 説明の先頭行 |
|---|---|---:|---|
| ClassDef | `BufferingStockOptimizerPlugin` | 56 | docstringなし（下のコード参照） |
| FunctionDef | `_reset_supply_layer_cleared_only` | 146 | Like decouple_optimizer._reset_supply_layer, but WITHOUT the |
| FunctionDef | `_resolve_sibling` | 67 | docstringなし（下のコード参照） |
| FunctionDef | `on_post_backward` | 72 | docstringなし（下のコード参照） |
| FunctionDef | `_apply` | 120 | docstringなし（下のコード参照） |
