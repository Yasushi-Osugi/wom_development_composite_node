...
`|residual|` が 96.7% にしかならなかったのは、真の最適の代わりに格子最適を引き算の相手に使っている以上、格子自身の誤差 328,958 の分だけ必ず少なく出るためである。
