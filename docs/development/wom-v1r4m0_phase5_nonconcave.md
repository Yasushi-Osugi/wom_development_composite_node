...
手計算による真の連続最適（設計書§2.3）：US 35,168 / EU 16,825 / JP 7、
profit=103,881,758。構造由来の取りこぼし＝10,057,058に対し、
`|structural_residual|`（9,728,100）は**96.7%**を捉える——下界として機能する。
...
構造由来を過小評価する（この例では96.7%）。したがって`residual`は「厳密な分解」
